...
def second_window():
    ...
    load2 = Image.open("C:/Users/Lenovo/PycharmProjects/Restaurant_billing/login.jpg")
    ...
    def Database():
        ...
        cursor.execute("SELECT * FROM `member` WHERE `username` = 'admin' AND `password` = 'admin' and username='anubhav' and password='anubhav123'and username='rollno' and password='220167201'")
        if cursor.fetchone() is None:
            ...
            cursor.execute("INSERT INTO `member` (username, password) VALUES('rollno', '220167201')")
            conn.commit()
    second.mainloop()
